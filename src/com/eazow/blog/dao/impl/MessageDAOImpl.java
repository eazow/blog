...
public class MessageDAOImpl implements MessageDAO
{
	...
	public boolean addMessage(Message message)
	{
		...
		try
		{
			...
			dbConnector.pstmt.setTimestamp(3, new Timestamp(message.getDate().getTime()));
	...
	public List<Message> getAllMessages()
	{
		...
		try
		{
			...
			{
				message = new Message(dbConnector.rs.getInt("id"), dbConnector.rs.getString("nickname"), 
						dbConnector.rs.getString("content"), dbConnector.rs.getTimestamp("date"));
