...
public class GetArticlesOfTagServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int totalPages = articleService.getTotalPagesOfTag(tagId, pageUtil
				.getPageSize());
		...
		if (totalPages != 0) {
			...
			articlesList = articleService.getArticlesOfTag(tagId, pageNum,
		...
		request.getRequestDispatcher("articlesOfTag.jsp").forward(request,
				response);
	}
