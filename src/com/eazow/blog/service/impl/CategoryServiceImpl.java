...
public class CategoryServiceImpl implements CategoryService {
	...
	public static CategoryService getCategoryServiceInstance(
			CategoryDAO categoryDAO, ArticleDAO articleDAO) {
	...
	public List<Category> getAllCategories() {
		...
		// {
		// int realArticlesNumOfCategory =
		// articleDAO.getArticlesNumOfCategory(category.getId());
	...
	public List<Category> manageAllCategories() {
		...
		for (Category category : categoriesList) {
			...
			List<Article> articles = this.articleDAO
					.getArticlesOfCategory(category.getId());
