...
public class ImageServiceImpl implements ImageService {
	...
	public static ImageService getImageServiceInstance(ImageDAO imageDAO,
			AlbumDAO albumDAO) {
	...
	public Image getNextImageOfAlbum(int imageId) {
		...
		int indexLocationOfAlbum = this.imageDAO.getIndexLocationOfAlbum(image
				.getId());
		image.setIndexLocationOfAlbum(indexLocationOfAlbum);
		return image;
	}
	...
	public void deleteImage(int id, String realRootPath) {
		...
		imageFile.delete();
		File thumbnailFile = new File(realRootPath
