...
public class TagServiceImpl implements TagService
{
	...
	private TagServiceImpl(TagDAO tagDAO, TagArticleDAO tagArticleDAO, ArticleDAO articleDAO)
	{
		this.tagDAO = tagDAO;
	...
	public static TagService getTagServiceInstance(TagDAO tagDAO, TagArticleDAO tagArticleDAO, ArticleDAO articleDAO)
	{
		if(null == tagService)
	...
	public List<Tag> manageAllTags()
	{
		...
		{
			List<Integer> articlesIds = this.tagArticleDAO.getAllArticlesIds(tag.getId());
