...
public class ImageUtil
{
	 ...
	 */
	public static void createThumbnail(String sourceImageUrl, String destImageUrl, int newSize)
	{
		try
		{
	        ...
	        FileOutputStream thumbnailOutputStream = new FileOutputStream(destImageUrl);
	        JPEGImageEncoder jpegImageEncoder = JPEGCodec.createJPEGEncoder(thumbnailOutputStream);
