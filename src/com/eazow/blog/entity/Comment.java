...
public class Comment
{
	...
	public Comment(int id, String content, int articleId, Date commentDate, String nickname)
	{
		this.id = id;
	...
	public Comment(String content, int articleId, Date commentDate, String nickname)
	{
		this.content = content;
		this.articleId = articleId;
		this.commentDate = commentDate;
