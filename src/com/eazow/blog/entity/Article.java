...
public class Article {
	...
	public Article(String title, String content, Date postDate, int categoryId,
			int commentsNum, int viewCount) {
		this.title = title;
	...
	public Article(int id, String title, String content, Date postDate,
			int categoryId, int commentsNum, int viewCount) {
		this.id = id;
		this.title = title;
		this.content = content;
		this.postDate = postDate;
